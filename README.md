...
Formerly developed under the working name PixelVision. The desktop UI is
**PySide6**. Entry point is `python main.py`.
...
- AUTO capture prefers **1920×1080@60**, then **1280×720@60**
...
- Scene gate: 20-frame Live/Held hysteresis
...
Left rail brand is **CHEATVISION**. Window title is **CheatVision**.
